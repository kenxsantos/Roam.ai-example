...
import 'package:roam_ai/pages/logger.dart';
                  ...
                  try {
                    switch (type) {
                      ...
                      case "updateTrip":
                        ...
                        //   logger.writeLog('Update trip response: $responseString');
                        //   setState(() {
                        //     tripId = roamTripResponse?.tripDetails?.id;
                        //   });
                        // }, ({error}) {
                      ...
                      try {
                        Roam.getTrip(tripId!, ({roamTripResponse}) {
                          String responseString =
                              jsonEncode(roamTripResponse?.toJson());
                          print('Get trip response: $responseString');
                          logger.writeLog('Get trip response: $responseString');
                          setState(() {
                            //tripId = roamTripResponse?.tripDetails?.id;
                    ...
                    onPressed: () async {
                      try {
                        ...
                        Roam.startTrip(({roamTripResponse}) {
                          ...
                          print('Start trip response: $responseString');
                          logger
                              .writeLog('Start trip response: $responseString');
                          setState(() {
                            //tripId = roamTripResponse?.tripDetails?.id;
                    ...
                    onPressed: () async {
                      try {
                        Roam.pauseTrip(tripId!, ({roamTripResponse}) {
                          ...
                          print('Pause trip response: $responseString');
                          logger
                              .writeLog('Pause trip response: $responseString');
                          setState(() {
                            //tripId = roamTripResponse?.tripDetails?.id;
                      ...
                      try {
                        Roam.endTrip(tripId!, false, ({roamTripResponse}) {
                          String responseString =
                              jsonEncode(roamTripResponse?.toJson());
                          print('End trip response: $responseString');
                          logger.writeLog('End trip response: $responseString');
                          setState(() {
                            //tripId = roamTripResponse?.tripDetails?.id;
                    ...
                    onPressed: () async {
                      try {
                        Roam.syncTrip(tripId!, ({roamSyncTripResponse}) {
                          ...
                          logger
                              .writeLog('Sync trip response: $responseString');
                          setState(() {
